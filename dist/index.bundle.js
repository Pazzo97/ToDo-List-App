...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_todo_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/todo-list.js */ \"./src/modules/todo-list.js\");\n/* harmony import */ var _crud_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./crud.js */ \"./src/crud.js\");\n/* harmony import */ var _interactions_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./interactions.js */ \"./src/interactions.js\");\n\n\n\n\n\nconst todoList = new _modules_todo_list_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n\ntodoList.loadToDos();\n\nconst displayTodos = document.querySelector('#todo-list');\ndisplayTodos.innerHTML = todoList.renderToDos();\n\n// if User clicks on enter add todo\nconst form = document.querySelector('.add-to-field');\nform.addEventListener('keypress', (e) => {\n  // if key is enter\n  if (e.keyCode === 13) {\n    e.preventDefault();\n    (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.addToList)(todoList);\n    displayTodos.innerHTML = todoList.renderToDos();\n  }\n});\n\nconst listenForEventsOnInputs = () => {\n  const inputs = document.querySelectorAll('.todo-description');\n\n  if (inputs) {\n    inputs.forEach((input) => {\n      input.addEventListener('change', (event) => {\n        (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.updateDescription)(todoList, event.target.dataset.id, event.target.value);\n        displayTodos.innerHTML = todoList.renderToDos();\n        listenForEventsOnInputs();\n      });\n    });\n    inputs.forEach((input) => {\n      input.addEventListener('focus', (event) => {\n        event.target.parentElement.classList.toggle('dark');\n      });\n    });\n\n    inputs.forEach((input) => {\n      input.addEventListener('blur', (event) => {\n        event.target.parentElement.classList.toggle('dark');\n      });\n    });\n  }\n};\n\ndocument.addEventListener('click', (event) => {\n  if (event.target.classList.contains('dots')) {\n    (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.removeFromList)(todoList, event.target.dataset.id);\n    displayTodos.innerHTML = todoList.renderToDos();\n    listenForEventsOnInputs();\n  }\n  if (event.target.classList.contains('check')) {\n    (0,_interactions_js__WEBPACK_IMPORTED_MODULE_3__.updateCompleted)(todoList, event.target.dataset.id);\n    displayTodos.innerHTML = todoList.renderToDos();\n    listenForEventsOnInputs();\n  }\n\n  if (event.target.classList.contains('btn')) {\n    (0,_interactions_js__WEBPACK_IMPORTED_MODULE_3__.removeCompletedFromList)(todoList);\n    displayTodos.innerHTML = todoList.renderToDos();\n    listenForEventsOnInputs();\n  }\n});\n\nlistenForEventsOnInputs();\n\n//# sourceURL=webpack://todo-list-app/./src/index.js?");
